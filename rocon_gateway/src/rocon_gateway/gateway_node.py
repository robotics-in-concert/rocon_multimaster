...
class GatewayNode():
    ...
    def _publish_gateway_info(self):
        ...
        try:
            ...
            gateway_info.discover_hubs_by_zeroconf = self._hub_discovery_thread._zeroconf_services_available
            gateway_info.discover_hubs_by_uri = self._hub_discovery_thread._direct_hub_uri_list
