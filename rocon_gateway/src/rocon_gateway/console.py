...
bold_black, bold_red, bold_gree, bold_yellow, bold_blue, bold_magenta, bold_cyan, bold_white = [ '1;'+ str(i) for i in range(30,38)]
colours = [ 
           bold,
           black, red, green, yellow, blue, magenta, cyan, white,
           bold_black, bold_red, bold_gree, bold_yellow, bold_blue, bold_magenta, bold_cyan, bold_white 
          ] 
